...
class HistogramCorrelationJob(Job):
    ...
    def run(self, *args, **kwargs):
        ...
        get_histogram = lambda area_name, frame_integer: histogram_function(area_name, unicode(frame_integer))
        ...
        def get_speaker_histogram_plane(frame_index):
            return map(lambda area_name: get_histogram(area_name, unicode(frame_index)), speaker_area_names)

        previous_slide_histogram = get_histogram('slides', unicode(1))
        ...
        for frame_index in range(2, number_of_files):
            ...
            slide_histogram = get_histogram('slides', unicode(frame_index))
    ...
    def get_outputs(self):
        ...
        # class CorrelationFromIndex(object):
        #     def __init__(self, correlations):
        #         self.correlations = correlations

        #     def __call__(frame_index):
        #         return self.correlations[frame_index]
