# -*- coding: utf-8 -*-
#
# Livius documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'Livius.tex', u'Livius Documentation',
   u'Max Planck for Intelligent Systems', 'manual'),
]
...
man_pages = [
    (master_doc, 'livius', u'Livius Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Livius', u'Livius Documentation',
   author, 'Livius', 'One line description of project.',
   'Miscellaneous'),
]
